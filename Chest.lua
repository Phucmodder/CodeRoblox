...
function Tween(Part)
	...
	local HumanoidRootPart = Player.Character:WaitForChild("HumanoidRootPart")
	_G.Tween = game:GetService("TweenService"):Create(HumanoidRootPart,TweenInfo.new((Part.Position-HumanoidRootPart.Position).magnitude/100,Enum.EasingStyle.Linear,Enum.EasingDirection.InOut),{CFrame = Part.CFrame})
	_G.Tween:Play()
	local flying = true
